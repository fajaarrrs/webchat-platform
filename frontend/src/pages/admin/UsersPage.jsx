...
import { Users, Search, Trash2, ShieldCheck, BadgeCheck, UserCircle, Filter } from 'lucide-react';
...
export default function UsersPage() {
  const { getAllUsers, deleteUser, addToast, user: currentUser } = useAuth();
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                          ...
                          <div>
                            <p style={{ fontSize: 13, fontWeight: 600, color: '#1F2937', margin: 0 }}>
                              {u.username}
                              {isSelf && (
                                <span style={{ marginLeft: 6, fontSize: 10, color: '#9CA3AF' }}>(Kamu)</span>
                              )}
                            </p>
                          </div>
                        </div>
                        ...
                        {isSelf ? (
                          ...
                          <button
                            ...
                            style={{
                              ...
                              fontSize: 12, color: '#6B7280', transition: 'all 0.15s',
                            }}
